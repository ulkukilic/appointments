      ...
      <tbody>
        @foreach($staff as $item)
          <tr>
            ...
            <td>
              <form method="POST" action="{{ route('admin.staff.toggle', $item->staff_member_uni_id) }}" class="d-inline">
                @csrf
                <button type="submit"
            ...
            <td>
              <a href="{{ route('admin.staff.edit', $item->staff_member_uni_id) }}" class="btn btn-sm btn-warning">
                Düzenle
              </a>
              <form method="POST"
